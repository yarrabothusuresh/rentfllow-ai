...
public class InvoiceController {
    ...
    private static final Set<String> INVOICE_SORT_FIELDS = Set.of(
            "id", "invoiceNumber", "status", "issueDate", "dueDate", "totalAmount", "amountPaid", "balanceDue", "createdAt", "updatedAt"
    );
    ...
    public ResponseEntity<?> listInvoices(
        ...
        try {
            ...
            Pageable pageable = PaginationUtil.createPageRequest(page, size, sortBy, direction, INVOICE_SORT_FIELDS);
            Page<InvoiceDTO> invoices = invoiceService.listInvoices(tenantId, status, customerId, bookingId, search, userRole, pageable);
