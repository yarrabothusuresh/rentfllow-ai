...
public class DamageClaimDTO {
    ...
    private List<DamageClaimItemDTO> items = new ArrayList<>();
    private List<ClaimEstimateDTO> estimates = new ArrayList<>();
    ...
    public List<DamageClaimItemDTO> getItems() { return items; }
    public void setItems(List<DamageClaimItemDTO> items) { this.items = items; }

    public List<ClaimEstimateDTO> getEstimates() { return estimates; }
    public void setEstimates(List<ClaimEstimateDTO> estimates) { this.estimates = estimates; }
}
