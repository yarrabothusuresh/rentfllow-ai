...
export class RoleStateService {
  ...
  private fallbackPermissions: Record<RoleType, string[]> = {
    ...
    WAREHOUSE: [
      'DASHBOARD_VIEW', 'AI_COPILOT_USE', 'PRODUCT_VIEW', 'INVENTORY_VIEW', 'INVENTORY_UPDATE', 'BOOKING_VIEW',
    ...
    OPERATIONS_MANAGER: [
      'DASHBOARD_VIEW', 'AI_COPILOT_USE', 'CUSTOMER_VIEW', 'LEAD_VIEW', 'PRODUCT_VIEW', 'PRODUCT_CREATE', 'PRODUCT_UPDATE',
    ...
    FINANCE: [
      'DASHBOARD_VIEW', 'AI_COPILOT_USE', 'BOOKING_VIEW', 'PAYMENT_VIEW', 'PAYMENT_CREATE', 'INVOICE_VIEW', 'WAREHOUSE_VIEW'
    ],
    DRIVER: [
